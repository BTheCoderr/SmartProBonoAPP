...
export const agentDescriptions = {
  greeting: {
    ...
    description: 'Handles simple greetings and helps you get started'
  },
  compliance: {
    icon: '🛡️',
    color: 'success',
    title: 'Compliance Expert',
    description: 'GDPR, SOC 2, privacy policies, and regulatory requirements'
  },
  business: {
    icon: '💼',
    color: 'warning',
    title: 'Business Law',
    description: 'Entity formation, fundraising, contracts, and IP'
  },
  document: {
    icon: '📄',
    color: 'info',
    title: 'Document Specialist',
    description: 'Document analysis, generation, and legal writing'
  },
  expert: {
    icon: '⚖️',
    color: 'error',
    title: 'Expert Referral',
    description: 'Complex legal matters and attorney connections'
  }
};
